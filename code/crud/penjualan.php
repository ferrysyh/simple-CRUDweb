...
<html>
    ...
    <div class="container-fluid">
        ...
        <form action="pros-penjualan.php" method="POST">
            ...
            <p>
                ...
                <input type="text" name="nopelanggan" placeholder="nopelanggan" />
            </p>
            <p>
                <label for="tanggalpenjualan">tanggalpenjualan : </label>
                <input type="text" name="tanggalpenjualan" placeholder="tanggalpenjualan" />
            </p>
            <p>
